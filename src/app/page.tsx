      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700 hover:border-blue-500 transition-all">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <span className="px-4 py-2 bg-gradient-to-r from-purple-600 to-purple-400 text-white rounded-full shadow-lg hover:scale-105 transition-transform cursor-default">TS</span>
            <span className="px-4 py-2 bg-gradient-to-r from-cyan-600 to-cyan-400 text-white rounded-full shadow-lg hover:scale-105 transition-transform cursor-default">React</span>
            <span className="px-4 py-2 bg-gradient-to-r from-teal-600 to-teal-400 text-white rounded-full shadow-lg hover:scale-105 transition-transform cursor-default">Tailwindcss</span>
            <span className="px-4 py-2 bg-gradient-to-r from-pink-600 to-pink-400 text-white rounded-full shadow-lg hover:scale-105 transition-transform cursor-default">Premierepro</span>
          </div>
        </div>
      </div>
    </div>
